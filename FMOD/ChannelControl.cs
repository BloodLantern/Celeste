...
namespace FMOD
{
    public class ChannelControl : HandleBase
    {
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_GetPaused(
            IntPtr channelgroup,
            out bool paused);

        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_GetVolume(
            IntPtr channelgroup,
            out float volume);

        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_SetVolumeRamp(
            IntPtr channelgroup,
            bool ramp);

        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_GetVolumeRamp(
            IntPtr channelgroup,
            out bool ramp);
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_GetPitch(
            IntPtr channelgroup,
            out float pitch);
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_SetLowPassGain(
            IntPtr channelgroup,
            float gain);

        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_GetLowPassGain(
            IntPtr channelgroup,
            out float gain);
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_IsPlaying(
            IntPtr channelgroup,
            out bool isplaying);
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_Set3DSpread(
            IntPtr channelgroup,
            float angle);

        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_Get3DSpread(
            IntPtr channelgroup,
            out float angle);

        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_Set3DLevel(
            IntPtr channelgroup,
            float level);

        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_Get3DLevel(
            IntPtr channelgroup,
            out float level);

        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_Set3DDopplerLevel(
            IntPtr channelgroup,
            float level);
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_SetVolume(
            IntPtr channelgroup,
            float volume);
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_AddDSP(
            IntPtr channelgroup,
            int index,
            IntPtr dsp);
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_GetNumDSPs(
            IntPtr channelgroup,
            out int numdsps);
        ...
        [DllImport("fmod")]
        private static extern RESULT FMOD_ChannelGroup_SetUserData(
            IntPtr channelgroup,
            IntPtr userdata);
