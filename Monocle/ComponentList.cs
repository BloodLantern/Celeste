...
namespace Monocle
{
    public class ComponentList : IEnumerable<Component>, IEnumerable
    {
        ...
        public void RemoveAll<T>() where T : Component => this.Remove((IEnumerable<Component>) this.GetAll<T>());
        ...
        public IEnumerator<Component> GetEnumerator() => (IEnumerator<Component>) this.components.GetEnumerator();
