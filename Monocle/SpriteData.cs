...
namespace Monocle
{
    ...
    {
        public List<SpriteDataSource> Sources = new();
        ...
        {
            SpriteDataSource spriteDataSource = new()
            {
                XML = xml
            };
            ...
            {
                _ = Sprite.JustifyOrigin(spriteDataSource.XML.ChildPosition("Justify"));
