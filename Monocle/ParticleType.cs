...
namespace Monocle
{
    public class ParticleType
    {
        ...
        public Particle Create(ref Particle particle, Vector2 position) => this.Create(ref particle, position, this.Direction);

        public Particle Create(ref Particle particle, Vector2 position, Color color) => this.Create(ref particle, (Entity) null, position, this.Direction, color);

        public Particle Create(ref Particle particle, Vector2 position, float direction) => this.Create(ref particle, (Entity) null, position, direction, this.Color);
