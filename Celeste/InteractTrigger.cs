...
namespace Celeste
{
    public class InteractTrigger : Entity
    {
            ...
            : base(data.Position + offset)
        {
            ...
            Vector2 drawAt = new(data.Width / 2, 0.0f);
            if (data.Nodes.Length != 0)
            {
                drawAt = data.Nodes[0] - data.Position;
            }

            Add(Talker = new TalkComponent(new Rectangle(0, 0, data.Width, data.Height), drawAt, new Action<Player>(OnTalk)));
        ...
        public override void Added(Scene scene)
        {
            ...
            else
            {
                ...
                scene.Add(new TheoPhone(Position + new Vector2((float)(((double)Width / 2.0) - 8.0), Height - 1f)));
            }
        }
