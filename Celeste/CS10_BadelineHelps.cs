...
namespace Celeste
{
    public class CS10_BadelineHelps : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return 0.3f;
            yield return Textbox.Say("CH9_HELPING_HAND", cs10BadelineHelps.MadelineFacesAway, cs10BadelineHelps.MadelineFacesBadeline, cs10BadelineHelps.MadelineStepsForwards);
        ...
        private IEnumerator BadelineAppears()
        {
            ...
            yield return cs10BadelineHelps.badeline.FloatTo(cs10BadelineHelps.player.Center + new Vector2(18f, -10f), -1, false);
            yield return 0.2f;
