    ...
    public class Poem : Entity
    {
        ...
        public void BeforeRender()
        {
            ...
            for (int index = 0; index < particles.Length; ++index)
            {
                ...
                float x = (float) (1.0 + num1 * 2.0);
                float y = (float) (0.25 * (0.25 + (1.0 - num1) * 0.75));
                float num2 = 1f - num1;
        ...
        public override void Render()
        {
            ...
            Draw.SpriteBatch.Draw((RenderTarget2D)smoke, Vector2.Zero, smoke.Bounds, Color.White * 0.3f * Alpha, 0.0f, Vector2.Zero, scale * 2f, SpriteEffects.None, 0.0f);
            Draw.SpriteBatch.Draw((RenderTarget2D)poem, Vector2.Zero, poem.Bounds, Color.White * Alpha, 0.0f, Vector2.Zero, scale, SpriteEffects.None, 0.0f);
        }
        ...
        private struct Particle
        {
            ...
            public void Reset(float percent)
            {
                ...
                Percent = percent;
                Duration = (float) (0.5 + Calc.Random.NextFloat() * 0.5);
            }
        }
    }
}
