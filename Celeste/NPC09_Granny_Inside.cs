    ...
    public class NPC09_Granny_Inside : NPC
    {
        ...
        public override void Update()
        {
            if (!talking && conversation == 0)
            {
                ...
                if (player != null && Math.Abs(player.X - X) < 48.0)
                    OnTalk(player);
            }
        ...
        private IEnumerator TalkRoutine(Player player)
        {
            ...
            else if (npC09GrannyInside.conversation == 0)
            {
                ...
                yield return 0.25f;
                yield return npC09GrannyInside.Level.ZoomTo(zoomPoint, 2f, 0.5f);
                yield return Textbox.Say("APP_OLDLADY_B", npC09GrannyInside.StartLaughing, npC09GrannyInside.StopLaughing);
            }
            else if (npC09GrannyInside.conversation == 1)
            {
                npC09GrannyInside.Sprite.Scale.X = -1f;
                yield return npC09GrannyInside.Level.ZoomTo(zoomPoint, 2f, 0.5f);
                yield return Textbox.Say("APP_OLDLADY_C", npC09GrannyInside.StartLaughing, npC09GrannyInside.StopLaughing);
            }
            else if (npC09GrannyInside.conversation == 2)
            {
                npC09GrannyInside.Sprite.Scale.X = -1f;
                yield return npC09GrannyInside.Level.ZoomTo(zoomPoint, 2f, 0.5f);
                yield return Textbox.Say("APP_OLDLADY_D", npC09GrannyInside.StartLaughing, npC09GrannyInside.StopLaughing);
            }
            else if (npC09GrannyInside.conversation == 3)
            {
                npC09GrannyInside.Sprite.Scale.X = -1f;
                yield return npC09GrannyInside.Level.ZoomTo(zoomPoint, 2f, 0.5f);
                yield return Textbox.Say("APP_OLDLADY_E", npC09GrannyInside.StartLaughing, npC09GrannyInside.StopLaughing);
            }
