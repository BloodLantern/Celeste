...
namespace Celeste
{
    ...
    {
        private readonly VertexPositionColor[] vertex = new VertexPositionColor[111];
        ...
        public override void Render(Scene scene)
        {
            ...
            else
            {
                ...
                {
                    float angleRadians1 = d + (float)(((double)num3 - (double)d) * ((index1 - 1) / 16.0));
                    float angleRadians2 = d + (float)(((double)num3 - (double)d) * (index1 / 16.0));
                ...
                {
                    float angleRadians3 = (float)(-1.5707963705062866 - ((index11 - 1) / 16.0 * (double)num13));
                    float angleRadians4 = (float)(-1.5707963705062866 - (index11 / 16.0 * (double)num13));
