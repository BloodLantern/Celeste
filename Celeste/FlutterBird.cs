...
namespace Celeste
{
    ...
    public class FlutterBird : Entity
    {
        ...
        private readonly SoundSource tweetingSfx;
        private readonly SoundSource flyawaySfx;
            ...
            : base(data.Position + offset)
        {
            ...
            sprite.Color = Calc.Random.Choose<Color>(FlutterBird.colors);
            Add(routine = new Coroutine(IdleRoutine()));
            Add(flyawaySfx = new SoundSource());
            Add(tweetingSfx = new SoundSource());
            _ = tweetingSfx.Play("event:/game/general/birdbaby_tweet_loop");
        }
        ...
        private IEnumerator IdleRoutine()
        {
            ...
            while (true)
            {
                ...
                _ = Audio.Play("event:/game/general/birdbaby_hop", flutterBird.Position);
                ...
                SimpleCurve bezier = new(flutterBird.Position, target, ((flutterBird.Position + target) / 2f) - (Vector2.UnitY * 14f));
        ...
        private IEnumerator FlyAwayRoutine(int direction, float delay)
        {
            ...
            while ((double)flutterBird.Y + 8.0 > level.Bounds.Top)
            {
        ...
        public void FlyAway(int direction, float delay)
        {
            ...
            _ = tweetingSfx.Stop();
            flyingAway = true;
            _ = flyawaySfx.Play("event:/game/general/birdbaby_flyaway");
            Remove(routine);
