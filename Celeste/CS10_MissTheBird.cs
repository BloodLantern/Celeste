...
namespace Celeste
{
    public class CS10_MissTheBird : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            cs10MissTheBird.bird.Add(new Coroutine(cs10MissTheBird.bird.Startle(null, 0.5f, new Vector2?(new Vector2(3f, 0.25f)))));
            ...
            {
                _ = cs10MissTheBird.player.MoveVExact(1);
            }
        ...
        private IEnumerator OpenBlackhole()
        {
            ...
            LightningStrike lightningStrike1 = new(new Vector2((float)x1, (float)top1), 80, 240f);
            ...
            LightningStrike lightningStrike2 = new(new Vector2((float)x2, (float)top2), 90, 240f, 0.5f);
