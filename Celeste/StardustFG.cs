...
namespace Celeste
{
    public class StardustFG : Backdrop
    {
        ...
        private readonly StardustFG.Particle[] particles = new StardustFG.Particle[50];
        private float fade;
        ...
        public override void Render(Scene level)
        {
            ...
            for (int index = 0; index < particles.Length; ++index)
            {
                ...
                float num = ((double)percent >= 0.699999988079071 ? Calc.ClampedMap(percent, 0.7f, 1f, 1f, 0.0f) : Calc.ClampedMap(percent, 0.0f, 0.3f)) * FadeAlphaMultiplier;
