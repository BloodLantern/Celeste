...
namespace Celeste
{
    public class OuiChapterPanel : Oui
    {
        ...
        private readonly List<OuiChapterPanel.Option> modes = new();
        private readonly List<OuiChapterPanel.Option> checkpoints = new();
        ...
        private List<OuiChapterPanel.Option> options => !selectingMode ? checkpoints : modes;
        ...
        public override bool IsStart(Overworld overworld, Overworld.StartMode start)
        {
            if (start is Overworld.StartMode.AreaComplete or Overworld.StartMode.AreaQuit)
            {
                ...
                _ = (double)overworld.Mountain.EaseCamera(Area.ID, Data.MountainSelect, new float?(1f));
        ...
        private void Reset()
        {
            ...
            modes.Add(new OuiChapterPanel.Option()
            {
        ...
        {
            OuiChapterPanel.Option option = new()
            {
        ...
        {
            _ = base.Overworld.Mountain.EaseCamera(Area.ID, Data.MountainIdle, null, true, false);
            base.Add(new Coroutine(EaseOut(true), true));
            yield break;
        }
        ...
        {
            Focused = false;
            _ = Audio.Play("event:/ui/world_map/chapter/checkpoint_start");
        ...
        public override void Update()
        {
            ...
            for (int index = 0; index < options.Count; ++index)
            {
                OuiChapterPanel.Option option = options[index];
            ...
            if (Selected && Focused)
            {
                ...
                {
                    _ = Audio.Play("event:/ui/world_map/chapter/tab_roll_left");
                    --option;
                    wiggler.Start();
                    if (selectingMode)
                    {
                    ...
                    {
                        _ = Audio.Play("event:/ui/world_map/chapter/checkpoint_photo_add");
                    }
                }
                else if (Input.MenuRight.Pressed && option + 1 < options.Count)
                {
                    _ = Audio.Play("event:/ui/world_map/chapter/tab_roll_right");
                    ++option;
                    wiggler.Start();
                    if (selectingMode)
                    {
                    ...
                    {
                        _ = Audio.Play("event:/ui/world_map/chapter/checkpoint_photo_remove");
                    }
                }
                else if (Input.MenuConfirm.Pressed)
                {
                    if (selectingMode)
                    {
                        ...
                        {
                            _ = Audio.Play("event:/ui/world_map/chapter/level_select");
                            Swap();
                        }
                    }
                    else
                ...
                else if (Input.MenuCancel.Pressed)
                {
                    if (selectingMode)
                    {
                        _ = Audio.Play("event:/ui/world_map/chapter/back");
                        _ = Overworld.Goto<OuiChapterSelect>();
                    }
                    else
                    {
                        _ = Audio.Play("event:/ui/world_map/chapter/checkpoint_back");
                        Swap();
                    }
                }
            }
            ...
            bool doRemixUnlock)
        {
            ...
            if (doHeartGem)
            {
                _ = Audio.Play("event:/ui/postgame/crystal_heart");
            ...
            if (doStrawberries)
            {
                ...
                {
                    yield return 0.25f;
                    _ = Audio.Play(ouiChapterPanel.strawberries.Amount >= ouiChapterPanel.Data.Mode[0].TotalStrawberries ? "event:/ui/postgame/strawberry_total_all" : "event:/ui/postgame/strawberry_total");
            ...
            if (doDeaths)
            {
                _ = Audio.Play("event:/ui/postgame/death_appear");
                ...
                while (newModeStats.Deaths > modeStats.Deaths)
                {
                    ...
                    _ = modeStats.Deaths >= newModeStats.Deaths
            ...
            else
            {
                ...
                while (!routine.Finished)
                {
                    if (MInput.GamePads[0].Pressed(Buttons.Start) || MInput.Keyboard.Pressed(Keys.Enter))
                    {
                        ...
                        _ = Audio.Play("event:/new_content/ui/skip_all");
                        break;
                    }
                    yield return null;
                }
                if (skipped & doRemixUnlock)
                {
                    ...
                    {
                        _ = ouiChapterPanel.AddRemixButton();
                    }
                    else
                    {
        ...
        private void PlayExpandSfx(float currentHeight, float nextHeight)
        {
            ...
            {
                _ = Audio.Play("event:/ui/world_map/chapter/pane_expand");
            }
            else
            {
                if ((double)nextHeight >= (double)currentHeight)
                ...
                _ = Audio.Play("event:/ui/world_map/chapter/pane_contract");
            }
        }
        ...
        private class Option
        {
            ...
            public void SlideTowards(int i, int count, bool snap)
            {
                ...
                float target = i - num;
                Slide = snap ? target : Calc.Approach(Slide, target, Engine.DeltaTime * 4f);
            }
