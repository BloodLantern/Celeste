    ...
    public class Starfield : Backdrop
    {
        ...
        public Starfield(Color color, float speed = 1f)
        {
            ...
            while (num2 < 15)
            {
                YNodes.Add(num1);
                ++num2;
                num1 += Calc.Random.Choose(-1, 1) * (16f + Calc.Random.NextFloat(24f));
            }
            ...
            for (int index1 = 0; index1 < Stars.Length; ++index1)
            {
                ...
                Stars[index1].Distance = (float) (4.0 + num3 * 20.0);
        ...
        {
            Vector2 vector2_1 = new Vector2(star.NodeIndex * 32, YNodes[star.NodeIndex]);
            Vector2 vector2_2 = new Vector2((star.NodeIndex + 1) * 32, YNodes[star.NodeIndex + 1]);
