...
namespace Celeste
{
    public class MountainRenderer : Renderer
    {
        ...
        public override void BeforeRender(Scene scene) => Model.BeforeRender(scene);
        ...
        public void SnapState(int state) => Model.SnapState(state);
        ...
        public void EaseState(int state) => Model.EaseState(state);
