...
namespace Celeste
{
    public class LavaRect : Component
    {
        ...
        private float Wave(int step, float length)
        {
            ...
            float num1 = OnlyMode != LavaRect.OnlyModes.None ? 1f : Calc.ClampedMap(val, 0.0f, length * 0.1f) * Calc.ClampedMap(val, length * 0.9f, length, 1f, 0.0f);
            ...
            if (OnlyMode != LavaRect.OnlyModes.None)
            {
        ...
        private void Edge(ref int vert, Vector2 a, Vector2 b, float fade, float insetFade)
        {
            ...
            float newMin = OnlyMode == LavaRect.OnlyModes.None ? insetFade / length : 0.0f;
        ...
        public override void Render()
        {
            ...
            if (dirty)
            {
                ...
                else if (OnlyMode == LavaRect.OnlyModes.OnlyTop)
                {
                ...
                else if (OnlyMode == LavaRect.OnlyModes.OnlyBottom)
                {
