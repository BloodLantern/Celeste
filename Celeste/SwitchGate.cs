...
namespace Celeste
{
    public class SwitchGate : Solid
    {
        ...
        private IEnumerator Sequence(Vector2 node)
        {
            ...
            yield return 0.1f;
            _ = switchGate.openSfx.Play("event:/game/general/touchswitch_gate_open");
            ...
            if (node.X <= (double)start.X)
            {
                ...
                for (int index = 0; index < (double)switchGate.Height / 8.0; ++index)
                {
                    Vector2 point1 = new(switchGate.Left - 1f, switchGate.Top + 4f + (index * 8));
            ...
            if (node.X >= (double)start.X)
            {
                ...
                for (int index = 0; index < (double)switchGate.Height / 8.0; ++index)
                {
                    Vector2 point3 = new(switchGate.Right + 1f, switchGate.Top + 4f + (index * 8));
            ...
            if (node.Y <= (double)start.Y)
            {
                ...
                for (int index = 0; index < (double)switchGate.Width / 8.0; ++index)
                {
                    Vector2 point5 = new(switchGate.Left + 4f + (index * 8), switchGate.Top - 1f);
            ...
            if (node.Y >= (double)start.Y)
            {
                ...
                for (int index = 0; index < (double)switchGate.Width / 8.0; ++index)
                {
                    Vector2 point7 = new(switchGate.Left + 4f + (index * 8), switchGate.Bottom + 1f);
            ...
            _ = Audio.Play("event:/game/general/touchswitch_gate_finish", switchGate.Position);
