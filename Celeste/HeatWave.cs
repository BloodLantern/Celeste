...
namespace Celeste
{
    public class HeatWave : Backdrop
    {
        ...
        private readonly Color[] currentColors;
        private float colorLerp;
        private readonly HeatWave.Particle[] particles = new HeatWave.Particle[50];
        private float fade;
        private float heat;
        private readonly Parallax mist1;
        private readonly Parallax mist2;
        private bool show;
