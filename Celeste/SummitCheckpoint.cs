...
namespace Celeste
{
    public class SummitCheckpoint : Entity
    {
        ...
        public override void Awake(Scene scene)
        {
            ...
            scene1.Session.RespawnPoint = respawn;
        }
        ...
        public override void Update()
        {
            ...
            scene.Session.RespawnPoint = respawn;
            scene.Session.UpdateLevelStartDashes();
            scene.Session.HitCheckpoint = true;
            scene.Displacement.AddBurst(Position, 0.5f, 4f, 24f, 0.5f);
        ...
        public class ConfettiRenderer : Entity
        {
                ...
                : base(position)
            {
                ...
                for (int index = 0; index < particles.Length; ++index)
                {
                    ...
                    particles[index].Color = Calc.Random.Choose(ConfettiRenderer.confettiColors);
