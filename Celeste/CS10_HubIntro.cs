...
namespace Celeste
{
    public class CS10_HubIntro : CutsceneEntity
    {
        ...
        private readonly List<EventInstance> sfxs = new();
            ...
            : base()
        {
            ...
            locks.Sort((a, b) => (int)((double)a.Y - (double)b.Y));
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            level1.Add(bird3);
            _ = Audio.Play("event:/new_content/game/10_farewell/bird_camera_pan_up");
        ...
        private class Bird : Entity
        {
            ...
            public IEnumerator FlyAwayRoutine()
            {
                ...
                float spd = -32f;
                while ((double)bird.Y > level.Bounds.Top - 32)
                {
