...
namespace Celeste
{
    public class NPC03_Theo_Vents : NPC
    {
        ...
        private IEnumerator Appear()
        {
            ...
            {
                npC03TheoVents.grate = new Grate(npC03TheoVents.Position);
                ...
                while (entity == null || entity.X <= npC03TheoVents.X - 32.0);
            ...
            npC03TheoVents.Visible = true;
            npC03TheoVents.Add(npC03TheoVents.Talker = new TalkComponent(new Rectangle(-16, 0, 32, 100), new Vector2(0.0f, -8f), npC03TheoVents.OnTalk));
        }
        ...
        {
            NPC03_Theo_Vents npC03TheoVents = this;
            yield return npC03TheoVents.PlayerApproach(player, spacing: 10f, side: -1);
