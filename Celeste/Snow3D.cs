...
namespace Celeste
{
    public class Snow3D : Entity
    {
        ...
        {
            Overworld scene = Scene as Overworld;
            Range = 20f;
        ...
        public class Particle : Billboard
        {
            ...
            private bool InView() => Manager.Frustum.Contains(Position) == ContainmentType.Contains && Position.Y > 0.0;

            private bool InLastView() => Manager.LastFrustum != null && Manager.LastFrustum.Contains(Position) == ContainmentType.Contains;
        }
    }
}
