...
namespace Celeste
{
    public class CS02_BadelineIntro : CutsceneEntity
    {
        ...
        public override void Update()
        {
            ...
            Distort.Anxiety = anxietyFade * Math.Max(0.0f, (float) (0.0 + anxietyJitter + anxietySine.Value * 0.30000001192092896));
        }
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("CH2_BADELINE_INTRO", cs02BadelineIntro.TurnAround, cs02BadelineIntro.RevealBadeline, cs02BadelineIntro.StartLaughing, cs02BadelineIntro.StopLaughing);
