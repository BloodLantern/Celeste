...
namespace Celeste
{
    public class CurtainWipe : ScreenWipe
    {
        ...
        public override void Render(Scene scene)
        {
            ...
            float percent = Math.Max(0.0f, Math.Min(1f, (float) ((num1 - 0.10000000149011612) / 0.89999997615814209 / 0.89999997615814209)));
            ...
            Vector2 begin2 = new Vector2((float) (896.0 + 200.0 * num1), (float) (256.0 * num2 - 350.0));
