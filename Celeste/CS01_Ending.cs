...
namespace Celeste
{
    public class CS01_Ending : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            _ = level.Session.Audio.Music.Layer(3, false);
            ...
            yield return 0.5f;
            yield return Textbox.Say("CH1_END", new Func<IEnumerator>(cs01Ending.EndCityTrigger));
            yield return 0.3f;
        ...
        private IEnumerator EndCityTrigger()
        {
            ...
            _ = Audio.Play("event:/char/madeline/campfire_sit", cs01Ending.player.Position);
            yield return 4f;
            BirdNPC bird = new(cs01Ending.player.Position + new Vector2(88f, -200f), BirdNPC.Modes.None);
            ...
            yield return 0.6f;
            _ = Audio.Play("event:/game/general/bird_squawk", bird.Position);
            yield return 0.9f;
