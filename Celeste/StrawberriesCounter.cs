...
namespace Celeste
{
    public class StrawberriesCounter : Component
    {
        ...
        public override void Render()
        {
            ...
            ActiveFont.DrawOutline(sAmount, renderPosition + vector * (float) (num - (double) x2 - x1 * 0.5) * Scale + vector2 * (wiggler.Value * 18f) * Scale, new Vector2(0.5f, 0.5f), Vector2.One * Scale, color, Stroke, Color.Black);
            if (!(text != ""))
                return;
