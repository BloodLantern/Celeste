    ...
    public class HiresSnow : Renderer
    {
        ...
        public override void Render(Scene scene)
        {
            ...
            if (flag)
            {
                ...
                vector2 = new Vector2(x, (float) (0.20000000298023224 + (1.0 - x / 20.0) * 0.800000011920929));
            }
            ...
            Draw.SpriteBatch.Draw(overlay.Texture.Texture, Vector2.Zero, new Rectangle(-(int) (timer * 32f % overlay.Width), -(int) (timer * 20f % overlay.Height), 1920, 1080), Color.White * (Alpha * overlayAlpha));
