...
namespace Celeste
{
    public class CS03_OshiroRooftop : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("CH3_OSHIRO_START_CHASE", new Func<IEnumerator>(cs03OshiroRooftop.MaddyWalkAway), new Func<IEnumerator>(cs03OshiroRooftop.MaddyTurnAround), new Func<IEnumerator>(cs03OshiroRooftop.EnterOshiro), new Func<IEnumerator>(cs03OshiroRooftop.OshiroGetsAngry));
        ...
        private IEnumerator MaddyWalkAway()
        {
            ...
            yield return 0.2f;
            _ = Audio.Play("event:/game/03_resort/suite_bad_moveroof", cs03OshiroRooftop.evil.Position);
        ...
        private IEnumerator OshiroGetsAngry()
        {
            ...
            evil = null;
            yield return 0.8f;
            _ = Audio.Play("event:/char/oshiro/boss_transform_begin", oshiro.Position);
        ...
        private IEnumerator OshiroTransform()
        {
            CS03_OshiroRooftop cs03OshiroRooftop = this;
            yield return 0.2f;
            _ = Audio.Play("event:/char/oshiro/boss_transform_burst", cs03OshiroRooftop.oshiro.Position);
        ...
        public override void OnEnd(Level level)
        {
            ...
            level.Session.RespawnPoint = new Vector2?(new Vector2(level.Bounds.Left + 170f, level.Bounds.Top + 160));
