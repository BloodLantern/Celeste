...
namespace Celeste
{
    public class CS03_OshiroLobby : CutsceneEntity
    {
        ...
        public override void Update()
        {
            ...
            Vector2 position = oshiro.Position + new Vector2(0.0f, -12f) + new Vector2(Calc.Random.Range(4, 12) * Calc.Random.Choose<int>(1, -1), Calc.Random.Range(4, 12) * Calc.Random.Choose<int>(1, -1));
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            _ = cs03OshiroLobby.sfx.Play("event:/game/03_resort/sequence_oshiro_intro");
            ...
            VertexLight light = new(new Vector2(0.0f, -8f), Color.White, 1f, 32, 64);
            BloomPoint bloom = new(new Vector2(0.0f, -8f), 1f, 16f);
            _ = level.Lighting.SetSpotlight(light);
            ...
            yield return cs03OshiroLobby.player.DummyWalkToExact((int)((double)cs03OshiroLobby.player.X - 12.0), true);
            ...
            tween = null;
            _ = Audio.SetMusic("event:/music/lvl3/oshiro_theme");
            cs03OshiroLobby.player.DummyAutoAnimate = true;
            yield return Textbox.Say("CH3_OSHIRO_FRONT_DESK", new Func<IEnumerator>(cs03OshiroLobby.ZoomOut));
