...
namespace Celeste
{
    public class EventTrigger : Trigger
    {
        ...
        public override void Awake(Scene scene)
        {
            ...
            if (entity == null || entity.Left <= (double) Right)
                return;
            RemoveSelf();
        }
        ...
        public override void OnEnter(Player player)
        {
            ...
            switch (Event)
            {
                ...
                case "ch9_ding_ding_ding":
                    Audio.Play("event:/new_content/game/10_farewell/pico8_flag", Center);
                    Decal decal1 = null;
                ...
                case "ch9_goto_the_past":
                    level.OnEndOfFrame += () =>
                    {
                        Vector2 vector2_1 = new Vector2(level.LevelOffset.X + level.Bounds.Width - player.X, player.Y - level.LevelOffset.Y);
