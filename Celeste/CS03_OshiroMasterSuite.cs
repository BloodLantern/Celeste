    ...
    public class CS03_OshiroMasterSuite : CutsceneEntity
    {
        ...
        private IEnumerator SuiteShadowAppear()
        {
            ...
            if (oshiroMasterSuite.mirror != null)
            {
                ...
                _ = Audio.Play("event:/game/03_resort/suite_bad_intro", oshiroMasterSuite.mirror.Position);
                Vector2 from = oshiroMasterSuite.Level.ZoomFocusPoint;
                Vector2 to = new(216f, 110f);
        ...
        private IEnumerator SuiteShadowDisrupt()
        {
            ...
            if (oshiroMasterSuite.mirror != null)
            {
                _ = Audio.Play("event:/game/03_resort/suite_bad_mirrorbreak", oshiroMasterSuite.mirror.Position);
        ...
        private IEnumerator SuiteShadowCeiling()
        {
            ...
            yield return oshiroMasterSuite.evil.FloatTo(new Vector2(oshiroMasterSuite.Level.Bounds.Left + 96, oshiroMasterSuite.evil.Y - 16f), new int?(1));
            oshiroMasterSuite.player.Facing = Facings.Left;
            yield return 0.25f;
