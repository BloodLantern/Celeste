...
namespace Celeste
{
    ...
    public class Water : Entity
    {
        ...
        public class Surface
        {
            ...
            public float GetSurfaceHeight(Vector2 position) => this.GetSurfaceHeight(this.GetPointAlong(position));
            ...
            public void Render(Camera camera) => GFX.DrawVertices<VertexPositionColor>(camera.Matrix, this.mesh, this.mesh.Length);
        }
    }
}
