...
namespace Celeste
{
    ...
    public class SpeedRing : Entity
    {
        ...
        public override void Render()
        {
            ...
            Draw.SpriteBatch.Draw((RenderTarget2D)GameplayBuffers.SpeedRings, Position + new Vector2(-32f, -32f), new Rectangle?(new Rectangle(index % 4 * 64, index / 4 * 64, 64, 64)), color);
        }
