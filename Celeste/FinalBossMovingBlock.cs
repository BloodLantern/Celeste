    ...
    public class FinalBossMovingBlock : Solid
    {
        ...
        private IEnumerator MoveSequence()
        {
            ...
            while (true)
            {
                ...
                {
                    for (float p = 0.0f; p < 1.0; p += Engine.DeltaTime / (float) (0.20000000298023224 + finalBossMovingBlock1.startDelay + 0.20000000298023224))
                    {
        ...
        public override void Render()
        {
            ...
            Position += Shake;
            base.Render();
            if (highlight.Alpha > 0.0 && highlight.Alpha < 1.0)
            {
