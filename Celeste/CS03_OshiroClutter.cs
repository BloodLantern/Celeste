...
namespace Celeste
{
    public class CS03_OshiroClutter : CutsceneEntity
    {
        ...
        public override void OnBegin(Level level)
        {
            ...
            doors.Sort((a, b) => (int) (a.Y - (double) b.Y));
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            if (cs03OshiroClutter.index < 3)
            {
                ...
                yield return Textbox.Say("CH3_OSHIRO_CLUTTER" + cs03OshiroClutter.index, cs03OshiroClutter.Collapse, cs03OshiroClutter.oshiro.PaceLeft, cs03OshiroClutter.oshiro.PaceRight);
