...
namespace Celeste
{
    public class Pathfinder
    {
        ...
        private readonly Pathfinder.Tile[,] map;
        private readonly List<Point> active = new();
        private readonly Pathfinder.PointMapComparer comparer;
        ...
        {
            this.level = level;
            map = new Pathfinder.Tile[200, 200];
            comparer = new Pathfinder.PointMapComparer(map);
        }
            ...
            bool logging = false)
        {
            ...
            while (active.Count > 0 && !flag)
            {
                ...
                {
                    Point point4 = new(Pathfinder.directions[index7].X, Pathfinder.directions[index7].Y);
                    Point point5 = new(point3.X + point4.X, point3.Y + point4.Y);
                    int num7 = 1;
                    if (point5.X >= 0 && point5.Y >= 0 && point5.X < num3 && point5.Y < num4 && !map[point5.X, point5.Y].Solid)
                    {
                        for (int index8 = 0; index8 < 4; ++index8)
                        {
                            Point point6 = new(point5.X + Pathfinder.directions[index8].X, point5.Y + Pathfinder.directions[index8].Y);
                        ...
                        if (map[point5.X, point5.Y].Cost > num8)
                        {
                            ...
                            map[point5.X, point5.Y].Parent = new Point?(point3);
