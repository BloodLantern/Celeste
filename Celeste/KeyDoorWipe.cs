...
namespace Celeste
{
    public class KeyDoorWipe : ScreenWipe
    {
        ...
        public override void Render(Scene scene)
        {
            int y1 = 1090;
            int num1 = 540;
            float num2 = WipeIn ? 1f - Percent : Percent;
            float num3 = Ease.SineInOut(Math.Min(1f, num2 / 0.5f));
            float num4 = Ease.SineInOut(1f - Calc.Clamp((float) ((num2 - 0.5) / 0.30000001192092896), 0.0f, 1f));
            float num5 = num3;
            float num6 = (float) (1.0 + (1.0 - num3) * 0.5);
            float x1 = 960f * num3;
            float x2 = 128f * num4 * num5;
            float y2 = 128f * num4 * num6;
            float y3 = num1 - num1 * 0.3f * num4 * num6;
            float y4 = num1 + num1 * 0.5f * num4 * num6;
            ...
            {
                float angleRadians2 = (float) (-1.5707963705062866 - (index4 - 1) / 8.0 * 1.5707963705062866);
                angleRadians1 = (float) (-1.5707963705062866 - index4 / 8.0 * 1.5707963705062866);
            ...
            int index10 = num14;
            int num15 = index10 + 1;
            vertex9[index10].Position = new Vector3(-10f, y1, 0.0f);
            for (int index11 = 1; index11 <= 6; ++index11)
            {
                float angleRadians3 = (float) (3.1415927410125732 - (index11 - 1) / 8.0 * 1.5707963705062866);
                angleRadians1 = (float) (3.1415927410125732 - index11 / 8.0 * 1.5707963705062866);
                VertexPositionColor[] vertex10 = vertex;
                int index12 = num15;
                int num16 = index12 + 1;
                vertex10[index12].Position = new Vector3(-10f, y1, 0.0f);
            ...
            int index15 = num15;
            int num18 = index15 + 1;
            vertex13[index15].Position = new Vector3(-10f, y1, 0.0f);
            ...
            int index18 = num20;
            int num21 = index18 + 1;
            vertex16[index18].Position = new Vector3(-10f, y1, 0.0f);
            ...
            int index21 = num23;
            int num24 = index21 + 1;
            vertex19[index21].Position = new Vector3(-10f, y1, 0.0f);
            ...
            int index23 = num25;
            int num26 = index23 + 1;
            vertex21[index23].Position = new Vector3(x1, y1, 0.0f);
