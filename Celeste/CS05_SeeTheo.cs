...
namespace Celeste
{
    public class CS05_SeeTheo : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            {
                yield return Textbox.Say("ch5_see_theo", new Func<IEnumerator>(cs05SeeTheo.ZoomIn), new Func<IEnumerator>(cs05SeeTheo.MadelineTurnsAround), new Func<IEnumerator>(cs05SeeTheo.WaitABit), new Func<IEnumerator>(cs05SeeTheo.MadelineTurnsBackAndBrighten));
            }
        ...
        private IEnumerator MadelineTurnsBackAndBrighten()
        {
            CS05_SeeTheo cs05SeeTheo = this;
            yield return 0.1f;
            Coroutine coroutine = new(cs05SeeTheo.Brighten());
