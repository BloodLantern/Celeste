...
namespace Celeste
{
    public class CS08_Ending : CutsceneEntity
    {
        ...
        public override void OnBegin(Level level)
        {
            ...
            Add(vignettebg = new Monocle.Image(GFX.Portraits["finalbg"]));
            vignettebg.Visible = false;
            Add(vignette = new Monocle.Image(GFX.Portraits[id]));
            vignette.Visible = false;
            _ = vignette.CenterOrigin();
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return 0.25f;
            yield return Textbox.Say("EP_CABIN", new Func<IEnumerator>(cs08Ending.BadelineEmerges), new Func<IEnumerator>(cs08Ending.OshiroEnters), new Func<IEnumerator>(cs08Ending.OshiroSettles), new Func<IEnumerator>(cs08Ending.MaddyTurns));
            FadeWipe fadeWipe2 = new(cs08Ending.Level, false)
            {
                Duration = 1.5f
            };
        ...
        private IEnumerator EndingRoutine()
        {
            ...
            StrawberriesCounter strawbs = new(true, SaveData.Instance.TotalStrawberries, 175, true);
            DeathsCounter deaths = new(AreaMode.Normal, true, SaveData.Instance.TotalDeaths);
            CS08_Ending.TimeDisplay time = new(str);
            float timeWidth = SpeedrunTimerDisplay.GetTimeWidth(str);
            cs08Ending.Add(strawbs);
            cs08Ending.Add(deaths);
            cs08Ending.Add(time);
            Vector2 from = new(960f, 1180f);
            Vector2 to = new(960f, 940f);
            ...
            yield return 0.25f;
            _ = cs08Ending.Level.CompleteArea(false);
        }
        ...
        {
            _ = Level.Displacement.AddBurst(player.Center, 0.5f, 8f, 32f, 0.5f, null, null);
            Level.Session.Inventory.Dashes = 1;
            player.Dashes = 1;
            Level.Add(badeline = new BadelineDummy(player.Position));
            _ = Audio.Play("event:/char/badeline/maddy_split", player.Position);
        ...
        {
            CS08_Ending cs08Ending = this;
            FadeWipe fadeWipe = new(cs08Ending.Level, false)
            {
                Duration = 1.5f
            };
            ...
            OshiroSprite oshiroSprite = new(1);
