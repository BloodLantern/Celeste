...
namespace Celeste
{
    public class CS00_Ending : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            from = new Vector2();
            to = new Vector2();
            _ = Audio.Play("event:/game/general/bird_land_dirt", cs00Ending.bird.Position);
            ...
            yield return 2f;
            _ = Audio.SetMusic("event:/music/lvl0/title_ping");
            yield return 2f;
        ...
        public override void OnEnd(Level level)
        {
            if (WasSkipped)
            {
                ...
                if (!keyOffed)
                {
                    _ = (int)Audio.CurrentMusicEventInstance.triggerCue();
                }
        ...
        private class EndingCutsceneDelay : Entity
        {
            ...
            {
                base.Add(new Coroutine(Routine(), true));
            }
            ...
            {
                yield return 3f;
                _ = (base.Scene as Level).CompleteArea(false, false, false);
                yield break;
            }
        }
    }
