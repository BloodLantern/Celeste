...
namespace Celeste
{
    public class CS05_TheoPhone : CutsceneEntity
    {
        ...
        private IEnumerator Routine()
        {
            ...
            if ((double)cs05TheoPhone.player.X != cs05TheoPhone.targetX)
            {
            ...
            yield return Textbox.Say("CH5_PHONE", new Func<IEnumerator>(cs05TheoPhone.WalkToPhone), new Func<IEnumerator>(cs05TheoPhone.StandBackUp));
        ...
        {
            Scene.Entities.FindFirst<TheoPhone>()?.RemoveSelf();
        }
    }
}
