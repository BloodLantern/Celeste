...
namespace Celeste
{
    public class ReflectionFG : Backdrop
    {
        ...
        private readonly ReflectionFG.Particle[] particles = new ReflectionFG.Particle[50];
        private float fade;
        ...
        private void Reset(int i, float p)
        {
            ...
            particles[i].Color = Calc.Random.Next(ReflectionFG.colors.Length);
        }
        ...
        public override void Render(Scene level)
        {
            ...
            for (int index = 0; index < particles.Length; ++index)
            {
                ...
                Draw.Rect(position, 1f, 1f, ReflectionFG.colors[particles[index].Color] * (fade * num));
            }
        }
