...
namespace Celeste
{
    public class CS05_Badeline : CutsceneEntity
    {
        ...
        private readonly NPC05_Badeline npc;
        private readonly BadelineDummy badeline;
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("ch5_shadow_maddy_" + cs05Badeline.index, new Func<IEnumerator>(cs05Badeline.BadelineLeaves));
