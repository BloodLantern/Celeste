...
namespace Celeste
{
    public class CS06_BossEnd : CutsceneEntity
    {
        ...
        private readonly NPC06_Badeline_Crying badeline;
        private float fade;
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("ch6_boss_ending", new Func<IEnumerator>(cs06BossEnd.StartMusic), new Func<IEnumerator>(cs06BossEnd.PlayerHug), new Func<IEnumerator>(cs06BossEnd.BadelineCalmDown));
            yield return 0.5f;
            ...
            _ = level.Session.Audio.Music.Param("levelup", 1f);
        ...
        private IEnumerator BadelineCalmDown()
        {
            ...
            _ = cs06BossEnd.badeline.LoopingSfx.Param("end", 1f);
            yield return 0.5f;
        ...
        {
            while ((double)(pictureFade = Calc.Approach(pictureFade, to, Engine.DeltaTime / duration)) != (double)to)
            {
                yield return null;
            }
        }
        ...
        public override void OnEnd(Level level)
        {
            ...
            if (WasSkipped)
            {
                _ = level.Session.Audio.Music.Param("levelup", 2f);
            }
