    ...
    public class AnimatedTiles : Component
    {
        ...
        public Rectangle GetClippedRenderTiles(int extend)
        {
            ...
            else
            {
                ...
                val1_1 = (int) Math.Max(0.0, Math.Floor(((double) clipCamera.Left - vector2.X) / 8.0) - extend);
                val1_2 = (int) Math.Max(0.0, Math.Floor(((double) clipCamera.Top - vector2.Y) / 8.0) - extend);
                val1_3 = (int) Math.Min(tiles.Columns, Math.Ceiling(((double) clipCamera.Right - vector2.X) / 8.0) + extend);
                val1_4 = (int) Math.Min(tiles.Rows, Math.Ceiling(((double) clipCamera.Bottom - vector2.Y) / 8.0) + extend);
            }
