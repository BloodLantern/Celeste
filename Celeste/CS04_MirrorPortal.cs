...
namespace Celeste
{
    public class CS04_MirrorPortal : CutsceneEntity
    {
        ...
        private readonly TempleMirrorPortal portal;
        ...
        public override void OnBegin(Level level)
        {
            ...
            level.Add(fader = new CS04_MirrorPortal.Fader());
        }
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            _ = cs04MirrorPortal.sfx.Play("event:/music/lvl5/mirror_cutscene");
            ...
            {
                _ = cs04MirrorPortal.player.MoveH(cs04MirrorPortal.player.Sprite.Rate * 10f * Engine.DeltaTime);
                _ = cs04MirrorPortal.player.MoveV((float)(-(1.0 - cs04MirrorPortal.player.Sprite.Rate) * 6.0) * Engine.DeltaTime);
