...
namespace Celeste
{
    public class Strawberry : Entity
    {
        ...
        private void OnAnimate(string id)
        {
            ...
            {
                _ = Audio.Play("event:/game/general/strawberry_wingflap", Position);
                flapSpeed = -50f;
            }
            ...
            {
                _ = Audio.Play("event:/game/general/strawberry_pulse", Position);
                _ = SceneAs<Level>().Displacement.AddBurst(Position, 0.6f, 4f, 28f, 0.1f);
            }
            else
            {
                _ = Audio.Play("event:/game/general/strawberry_pulse", Position);
                _ = SceneAs<Level>().Displacement.AddBurst(Position, 0.6f, 4f, 28f, 0.2f);
            }
        }
        ...
        public void OnPlayer(Player player)
        {
            ...
            if (Winged)
            {
                ...
                Winged = false;
                sprite.Rate = 0.0f;
                _ = Alarm.Set(this, Follower.FollowDelay, () =>
                {
                    sprite.Rate = 1f;
                    sprite.Play("idle");
            ...
            _ = Audio.Play(isGhostBerry ? "event:/game/general/strawberry_blue_touch" : "event:/game/general/strawberry_touch", Position);
        ...
        private IEnumerator FlyAwayRoutine()
        {
            ...
            yield return 0.1f;
            _ = Audio.Play("event:/game/general/strawberry_laugh", strawberry.Position);
            yield return 0.2f;
            if (!strawberry.Follower.HasLeader)
            {
                _ = Audio.Play("event:/game/general/strawberry_flyaway", strawberry.Position);
            }
        ...
        private IEnumerator CollectRoutine(int collectIndex)
        {
            ...
            _ = Audio.Play("event:/game/general/strawberry_get", strawberry.Position, "colour", num, "count", collectIndex);
