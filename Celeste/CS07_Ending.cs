...
namespace Celeste
{
    public class CS07_Ending : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return cs07Ending.badeline.FloatTo(cs07Ending.target + new Vector2(-10f, -30f), 1, false);
            yield return 0.5f;
            yield return Textbox.Say("CH7_ENDING", cs07Ending.WaitABit, cs07Ending.SitDown, cs07Ending.BadelineApproaches);
            yield return 1f;
