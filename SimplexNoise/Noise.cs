...
namespace SimplexNoise
{
    public class Noise
    {
        ...
        public static float Generate(float x, float y)
        {
            ...
            float x4 = (float)((double)x3 - num7 + 0.21132487058639526);
            float y2 = (float)((double)y1 - num8 + 0.21132487058639526);
        ...
        public static float Generate(float x, float y, float z)
        {
            ...
            float num2 = (x4 + x5 + x6) * 0.166666672f;
            float num3 = x4 - num2;
            float num4 = x5 - num2;
            float num5 = x6 - num2;
            float x7 = x - num3;
            ...
            float x8 = (float)((double)x7 - num6 + 0.1666666716337204);
            float y2 = (float)((double)y1 - num7 + 0.1666666716337204);
            float z2 = (float)((double)z1 - num8 + 0.1666666716337204);
            float x9 = (float)((double)x7 - num9 + 0.3333333432674408);
            float y3 = (float)((double)y1 - num10 + 0.3333333432674408);
            float z3 = (float)((double)z1 - num11 + 0.3333333432674408);
        ...
        {
            return (double)x <= 0.0 ? (int)x - 1 : (int)x;
        }
        ...
        private static float grad(int hash, float x, float y, float z)
        {
            ...
            float num3 = num1 < 4 ? y : (num1 is 12 or 14 ? x : z);
